# Pegando as informações do objeto vindas da câmera (esteira rolete)
...
coppelia = CoppeliaSim(scene='test2_2.ttt')
...
while coppelia.Cuboids.CheckToHandle():
    if len(coppelia.ArucoVision.detected) == 0:
        ...
        # # Ruído na velocidade
        # if count_vel == 2:
        #     vel = random.randrange(1,10)*Conv.vel
...
SaveData('test2_2', velocity, real, kalman, integration, camera)
Plot('test2_2', camera=True)